...
{
    public class AddDecoratedTransientTests
    {
        ...
        public void Should_Throw_ForNullServices()
        {
            Assert.Throws<ArgumentNullException>(() =>
                ServiceCollectionExtensions.AddDecoratedTransient(null, _serviceType, _serviceDecorators));
        ...
        {
            Assert.Throws<ArgumentNullException>(() =>
                _services.AddDecoratedTransient(null, _serviceDecorators));
        }
        ...
        {
            Assert.Throws<ArgumentNullException>(() =>
                _services.AddDecoratedTransient(_serviceType, null));
        }
        ...
        public void Should_Throw_ForEmptyDecoratorTypes()
        {
            Assert.Throws<ArgumentException>(() =>
                _services.AddDecoratedTransient(_serviceType, Array.Empty<Type>()));
        }

        [Fact]
        public void Should_Register_TypesIndividually()
        {
            _services.AddDecoratedTransient(_serviceType, _serviceDecorators);
        ...
        public void Should_Resolve_Decorated()
        {
            ...
            using var serviceProvider = _services.AddDecoratedTransient(_serviceType, _serviceDecorators)
        ...
        public void Should_Resolve_TypedWith1Decorators()
        {
            ...
            using var serviceProvider = _services.AddDecoratedTransient<IServiceToDecorate, Decorator1, OriginalImpl>()
                .BuildServiceProvider();
        ...
        public void Should_Resolve_TypedWith2Decorators()
        {
            ...
            using var serviceProvider = _services.AddDecoratedTransient<IServiceToDecorate, Decorator2, Decorator1, OriginalImpl>()
                .BuildServiceProvider();
        ...
        public void Should_Resolve_TypedWith3Decorators()
        {
            ...
            using var serviceProvider = _services.AddDecoratedTransient<IServiceToDecorate, Decorator3, Decorator2, Decorator1, OriginalImpl>()
                .BuildServiceProvider();
        ...
        public void Should_Resolve_TypedWith4Decorators()
        {
            ...
            using var serviceProvider = _services.AddDecoratedTransient<IServiceToDecorate, Decorator4, Decorator3, Decorator2, Decorator1, OriginalImpl>()
                .BuildServiceProvider();
        ...
        public void Should_Resolve_TypedWith5Decorators()
        {
            ...
            using var serviceProvider = _services.AddDecoratedTransient<IServiceToDecorate, Decorator5, Decorator4, Decorator3, Decorator2, Decorator1, OriginalImpl>()
                .BuildServiceProvider();
