...
{
    public class AddDecoratedScopedTests
    {
        ...
        public void Should_Throw_ForNullServices()
        {
            Assert.Throws<ArgumentNullException>(() =>
                ServiceCollectionExtensions.AddDecoratedScoped(null, _serviceType, _serviceDecorators));
        ...
        {
            Assert.Throws<ArgumentNullException>(() =>
                _services.AddDecoratedScoped(null, _serviceDecorators));
        }
        ...
        {
            Assert.Throws<ArgumentNullException>(() =>
                _services.AddDecoratedScoped(_serviceType, null));
        }
        ...
        public void Should_Throw_ForEmptyDecoratorTypes()
        {
            Assert.Throws<ArgumentException>(() =>
                _services.AddDecoratedScoped(_serviceType, Array.Empty<Type>()));
        }

        [Fact]
        public void Should_Register_TypesIndividually()
        {
            _services.AddDecoratedScoped(_serviceType, _serviceDecorators);
        ...
        public void Should_Resolve_Decorated()
        {
            ...
            using var serviceProvider = _services.AddDecoratedScoped(_serviceType, _serviceDecorators)
        ...
        public void Should_Resolve_TypedWith1Decorators()
        {
            ...
            using var serviceProvider = _services.AddDecoratedScoped<IServiceToDecorate, Decorator1, OriginalImpl>()
                .BuildServiceProvider();
        ...
        public void Should_Resolve_TypedWith2Decorators()
        {
            ...
            using var serviceProvider = _services.AddDecoratedScoped<IServiceToDecorate, Decorator2, Decorator1, OriginalImpl>()
                .BuildServiceProvider();
        ...
        public void Should_Resolve_TypedWith3Decorators()
        {
            ...
            using var serviceProvider = _services.AddDecoratedScoped<IServiceToDecorate, Decorator3, Decorator2, Decorator1, OriginalImpl>()
                .BuildServiceProvider();
        ...
        public void Should_Resolve_TypedWith4Decorators()
        {
            ...
            using var serviceProvider = _services.AddDecoratedScoped<IServiceToDecorate, Decorator4, Decorator3, Decorator2, Decorator1, OriginalImpl>()
                .BuildServiceProvider();
        ...
        public void Should_Resolve_TypedWith5Decorators()
        {
            ...
            using var serviceProvider = _services.AddDecoratedScoped<IServiceToDecorate, Decorator5, Decorator4, Decorator3, Decorator2, Decorator1, OriginalImpl>()
                .BuildServiceProvider();
